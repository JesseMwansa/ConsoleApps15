    ...
    public class BMI
    {
        ...
        private Unit SelectUnit()
        {
            ...
            while (choice != "1" || choice != "2")
            {
                if (choice == "1")
                {
                    feet = ConsoleHelper.InputNumber("Input Your Height In Feet >");
                    inch = ConsoleHelper.InputNumber("Input Your Height In Inches >");
                    convertedFeet = inch * FEET_IN_INCHES;
                    inch = inch + convertedFeet;
                    pound = ConsoleHelper.InputNumber("Input Your Weight In Pounds >");
                    stone = ConsoleHelper.InputNumber("Input Your Weight In Stones >");
                ...
                {
                    meter = ConsoleHelper.InputNumber("Input Your Height In Metres >");
                    kilogram = ConsoleHelper.InputNumber("Input Your Weight In Kilograms >");
                    return Unit.Metric;
                }
                else 
                {
        ...
        private void OutputBMI ()
        {
            ...
            Console.WriteLine("If you are of minority, the risk is higher.");
            Console.WriteLine();
